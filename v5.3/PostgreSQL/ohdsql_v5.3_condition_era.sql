...
(
	...
	/* Depending on the needs of your data, you can put more filters on to your code. We assign 0 to our unmapped condition_concept_ids,
	 * and since we do not want different conditions put in the same era, we put in the filter below.
 	 */
...
INTO @cdmDatabaseSchema.condition_era
